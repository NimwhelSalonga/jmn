 <div class="modal fade text-start" id="add-supplier" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 ...
                 <button class="btn btn-success" type="button" id="btn-supplier">Save</button>
 ...
 <script>
     document.addEventListener('DOMContentLoaded', () => {
         let btn = document.querySelector('#btn-supplier');
         btn.addEventListener('click', () => {

             const supplier_name = document.querySelector('input[id=fullname]').value;
             ...
             if (supplier_name == '' || contact_number == '' || address == '') {
                 ...
                 $.ajax({
                     url: '../function/controllers/supplier.php?action=add_supplier',
                     type: "POST",
                     data: data,
                     processData: false,
                     contentType: false,
